...
class Login extends CI_Controller {
	...
	public function set_new_password()
	{
		...
		$this->form_validation->set_rules('resettoken', 'Token', 'required');
		$this->form_validation->set_rules('password', 'Password', 'required');
...
public function new_pass()
	{
		...
		$this->load->view('account/reset_pass', $this->data, FALSE);
	...
	public function set_new_pass()
	{
		...
		$this->session->set_flashdata('message', 'Se ha actualizado la nueva contrase�a, puede iniciar sesi�n ahora');
		$this->session->set_flashdata('message_type', 'success');
		redirect('login', 'refresh');
