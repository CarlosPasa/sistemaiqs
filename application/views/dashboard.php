...
<section class="content-header">
  <h1>
    Dashboard
    <small>overview for your company</small>
  </h1>
</section>
    ...
    <div class="col-sm-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number"><?php echo $this->users_model->countAll() ?></span>
        </div>
        <!-- /.info-box-content -->
      </div>
    </div>
    ...
    <div class="col-sm-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number"><?php echo $this->roles_model->countAll() ?></span>
        </div>
        <!-- /.info-box-content -->
      </div>
    </div>
    ...
    <div class="col-sm-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number"><?php echo $this->permissions_model->countAll() ?></span>
        </div>
        <!-- /.info-box-content -->
      </div>
    </div>
    ...
    <div class="col-sm-3">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number"><?php echo rand(11, 99) ?></span>
        </div>
        <!-- /.info-box-content -->
      </div>
    </div>
    ...
    <section class="col-lg-7 connectedSortable">
      ...
      <div class="box box-success">
        ...
        <div class="box-body chat" id="chat-box">
          <!-- chat item -->
          <div class="item">
            <img src="<?php echo $url->assets ?>img/user4-128x128.jpg" alt="user image" class="online">
          ...
          <!-- chat item -->
          <div class="item">
            <img src="<?php echo $url->assets ?>img/user3-128x128.jpg" alt="user image" class="offline">
          ...
          <!-- chat item -->
          <div class="item">
            <img src="<?php echo $url->assets ?>img/user2-160x160.jpg" alt="user image" class="offline">
